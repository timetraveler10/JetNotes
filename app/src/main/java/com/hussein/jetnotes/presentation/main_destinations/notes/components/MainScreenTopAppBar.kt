...
fun MainScreenTopAppBar(
    ...
    if (isSelectionModeEnabled) {
        TopAppBar(title = { Text("Selected Notes: $selectedNotesCount") }, actions = {

            FilledTonalIconButton(onClick = onDeleteSelected) {
                Icon(
            ...
            FilledTonalIconButton(onClick = onDiscardSelection) {
                Icon(
