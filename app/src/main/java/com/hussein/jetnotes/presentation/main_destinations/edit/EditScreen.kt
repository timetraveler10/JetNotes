...
import com.hussein.jetnotes.presentation.main_destinations.edit.components.EditScreenBottomBar
import com.hussein.jetnotes.presentation.main_destinations.edit.components.EditScreenFormattingBottomSheet
import com.hussein.jetnotes.presentation.main_destinations.edit.components.EditScreenTopAppBar
        ...
        Scaffold(
            modifier = Modifier
                .sharedElement(
                    ...
                    animatedVisibilityScope = animatedContentScope).fillMaxSize()
                .navigationBarsPadding(),
            topBar = {
                EditScreenTopAppBar(onNavigateBack = ::onNavigateBack, onClickOnShowMore = {})
            }, bottomBar = {
                EditScreenBottomBar(
                    modifier = Modifier.height(64.dp).fillMaxWidth().imePadding(),
            ...
            if (sheetContentState.value != EditScreenSheetState.Hidden) {
                ModalBottomSheet(
                    ...
                    when (sheetContentState.value) {
                        ...
                        EditScreenSheetState.Hidden -> Unit
                    }
                }
            }
